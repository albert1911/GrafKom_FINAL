...
namespace objectFinal
{
    class Asset3d
    {
        ...
        {
            var awan = new Asset3d(new Vector3(1, 1, 1));
            var awan1 = new Asset3d(new Vector3(0.8f, 0.8f, 0.8f));
            awan1.createEllipsoid(-2.75f, 6f, 2f, 1f, 0.5f, 0.5f, 30, 24);
            var awan2 = new Asset3d(new Vector3(0.8f, 0.8f, 0.8f));
            awan2.createEllipsoid(-2f, 6.5f, 2f, 1f, 0.5f, 0.5f, 30, 24);
            var awan3 = new Asset3d(new Vector3(0.8f, 0.8f, 0.8f));
            awan3.createEllipsoid(-1.75f, 6f, 2f, 1f, 0.5f, 0.5f, 30, 24);
            var awan4 = new Asset3d(new Vector3(0.8f, 0.8f, 0.8f));
            awan4.createEllipsoid(-1f, 6f, 2f, 1f, 0.5f, 0.5f, 30, 24);
